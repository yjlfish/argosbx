...
export uuid=${uuid:-'9e62ffe6-e4a8-4a03-b722-679797e4ebdc'}
export port_vl_re=${vlpt:-''}
export port_vm_ws=${vmpt:-'46466'}
export port_vw=${vwpt:-''}
...
export ARGO_DOMAIN=${agn:-'vmclaw.itcf.netlib.re'}
export ARGO_AUTH=${agk:-'eyJhIjoiMDUxOGQ3YzVhZTEwMWU1OGM3YzY1OTNmZTIyNDRjZDYiLCJ0IjoiYzU5MDk0NzMtY2JkNC00YTdlLWIyNDAtYTJlOTEzODVjNGQ4IiwicyI6Ik5UTmtPV0ZtWldRdFlURmlOaTAwT1dZNUxUazNNV1F0TkdFeVl6UXdPR0kxTTJRdyJ9'}
export ippz=${ippz:-''}
export warp=${warp:-''}
export name=${name:-''}
export oap=${oap:-''}
